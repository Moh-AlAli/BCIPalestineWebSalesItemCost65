...
Public Class toware
    ...
    Private Sub toware_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try

            'Dim arv As AccpacView
            'arv = SalesItem.xdbcom.OpenView2("IC0370")
            'Dim arcusds As DataSet = New DataSet("IC")
            'Dim cust As DataTable = arcusds.Tables.Add("ICLOC")
        ...
        Try
          ...
          If Txtloc.Text <> Nothing And Txtname.Text <> Nothing Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                SalesItem.Txttoloc.Text = dt.Rows(i)(0)

            End If
            SalesItem.Btdloc.Enabled = True
            Close()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
