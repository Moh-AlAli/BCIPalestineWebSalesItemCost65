...
Public Class ToCat
    ...
    Private Sub ToCat_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            'Dim cust As DataTable = arcusds.Tables.Add("ICCAT")
    ...
    Private Sub ButSel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButSel.Click
        Try
            ...
            SalesItem.Txttocat.Text = dt.Rows(i)(0)
            SalesItem.Btdcat.Enabled = True
            Close()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
