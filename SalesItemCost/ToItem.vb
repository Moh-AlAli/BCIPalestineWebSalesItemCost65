...
Public Class ToItem
    ...
    Private Sub ToItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            'arv = SalesItem.xdbcom.OpenView2("IC0310")
            ...
            arcusds = c.Items("", OPCompany.compid)
    ...
    Private Sub ButSel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButSel.Click
        Try
            ...
            'Dim arv As AccpacView
            'arv = Itembalbyopt.xdbcom.OpenView2("IC0310")
            Dim searfil As String = ""

            If Txtcusno.Text <> Nothing And Txtname.Text <> Nothing Then
                searfil = " Where DESC Like N'%" + Txtname.Text + "%' and ITEMNO like N'%" + Txtcusno.Text + "%' "
            ...
            ElseIf Txtcusno.Text <> Nothing And Txtname.Text = Nothing Then
                searfil = " Where ITEMNO like N'%" + Txtcusno.Text + "%' "
            End If
            ...
            Dim c As New Clsfunct
            Dim arcusds As New DataSet
            arcusds = c.Items(searfil, OPCompany.compid)

            Dim dt As DataTable = arcusds.Tables(0)

            i = DGfcus.CurrentCell.RowIndex
            j = DGfcus.CurrentCell.ColumnIndex
            SalesItem.Txttoitem.Text = dt.Rows(i)(0)
            SalesItem.btdit.Enabled = True
            Close()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
